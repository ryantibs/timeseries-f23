...
date: 'Due Tuesday September 10 at 5pm'
output:
  html_document:
    toc: true
    toc_float: true
...
The total number of points possible for this homework is XYZ. The number of 
...
independent. You must explicitly prove that they are not independent (for this, 
you may invoke any property that you know is equivalent to independence).
