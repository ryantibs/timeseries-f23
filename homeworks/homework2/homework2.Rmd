...
Additionally (all on the same figure), plot the fitted values on the training
set, and print the MAE on the training set somewhere on the plot (label this as 
"Training MAE" in order to clearly differentiate it).
