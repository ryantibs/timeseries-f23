...
\item Figure \ref{fig:st_decomposition} shows an example on the holiday travel
  data. Both additive and multiplicative methods return fairly similar component
  estimates. The seasonal pattern also appears to be unchanging over time, which
  is a consequence of the fact that the estimate of $\gamma$ in both models is
  tiny (around 0.0001 in both models, as can be seen in the R notebook)
