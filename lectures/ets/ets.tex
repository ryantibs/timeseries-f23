...
\item A useful way to represent (and think about) ETS models is what is called
  a \emph{state space} formulation. This provides a statistical framework for
  ETS models: it provides equivalent point forecasts \smash{$\hat{x}_{t+h |
      t}$}, and importantly, goes beyond this, and provides us with a way to
