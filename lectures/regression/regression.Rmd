...
# Lagged features, split-sample forecasts
...
# Lagged features, cross-validation
...
for (t in (t0+1):n) {
  reg_all_past = lm(cmort_vec ~ x, subset = (1:n) < t)
  reg_trailing = lm(cmort_vec ~ x, subset = (1:n) < t & (1:n) >= t-10)
