...
\item We will not cover this further, in any real detail, because (a) you'll
  ...
  concepts of statistics class, and (b) we won't really rely on classical
  ...
  discussed already, can be a dubious assumption in practice
\end{itemize}
...
\item We will not cover these. These are classical tools for variable/model
  ...
  interested. We'll take a more predictive angle, and simply use
